...
const mockReviews = [
  ...
  },
  {
    ...
    date: "5 days ago",
    content:
      "Average experience. Nothing particularly stood out, either good or bad. Service was okay, but there's definitely room for improvement.",
    responded: false,
    sentiment: "neutral",
    initials: "ER",
    avatar: "/placeholder.svg?height=40&width=40",
  },
  {
    ...
    date: "1 week ago",
    content:
      "Terrible experience from start to finish. The staff was rude and unhelpful. I will not be returning and would not recommend to anyone.",
    responded: false,
    sentiment: "negative",
    initials: "DW",
    avatar: "/placeholder.svg?height=40&width=40",
  },
  {
    ...
    date: "1 week ago",
    content:
      "Very good experience overall. The product quality was excellent and the staff was knowledgeable. Would have given 5 stars if the prices were a bit more reasonable.",
    responded: true,
    sentiment: "positive",
    initials: "JL",
    avatar: "/placeholder.svg?height=40&width=40",
...
export function ReviewsList({ filter = "all" }) {
